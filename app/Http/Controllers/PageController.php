...
class PageController extends Controller
{
    public function welcome()
    {
        ...
        $contactDetails = [
            ...
            'location_line1' => $aboutContent->contact_location_line1 ?? 'Abarinzi Family Main Building',
            ...
            'social_links' => $aboutContent->social_links ?? [ // Example, assuming social_links is a JSON field in AboutContent
                ['platform' => 'Facebook', 'url' => '#', 'icon_svg_path' => 'M24...'],
                ['platform' => 'Twitter', 'url' => '#', 'icon_svg_path' => 'M23...'],
            ],
        ];
